...
drop index if exists "public"."frc_match_breakdowns_json_path_idx";

drop index if exists "public"."frc_match_breakdowns_pkey";

alter table "public"."frc_match_breakdowns" drop column "json_path";

alter table "public"."frc_match_breakdowns" add column "path" text not null;

CREATE INDEX frc_match_breakdowns_path_idx ON public.frc_match_breakdowns USING gin (path gin_trgm_ops);

CREATE UNIQUE INDEX frc_match_breakdowns_pkey ON public.frc_match_breakdowns USING btree (match_key, alliance, path);
